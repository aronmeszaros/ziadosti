...
<div class="container">
    ...
    <div class="row justify-content-center my-4">
        <div class="col-md-8">
          <div class="jumbotron">
            <h1 class="display-4">Component Browser</h1>
            ...
            <a class="btn btn-primary btn-lg m-2" href="#" role="button" data-toggle="modal" data-target="#simpleComponent" data-whatever="dropdown"><i class="fas fa-caret-square-down"></i> Dropdown</a>
